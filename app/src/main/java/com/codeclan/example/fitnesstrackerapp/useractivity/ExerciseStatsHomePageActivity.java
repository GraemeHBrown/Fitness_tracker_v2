...
public class ExerciseStatsHomePageActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_exercise_stats_home_page);
        Toolbar toolbar = (Toolbar) findViewById(R.id.stats_home_page_activity_toolbar);
        setSupportActionBar(toolbar);
        ActionBar ab = getSupportActionBar();

    }

    public void onViewDistanceStatsButtonClick(View button) {
        Intent intent = new Intent(this, ExerciseStatsActivity.class);
        startActivity(intent);
    }

    public void onViewDurationButtonClick(View button) {
        Intent intent = new Intent(this, ExerciseStatsDurationActivity.class);
        startActivity(intent);
    }
